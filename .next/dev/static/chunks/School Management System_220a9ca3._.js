...
function List({ currentStudents, handleDelete, currentPage, setCurrentPage, totalPages, totalCount, startIndex, endIndex, children }) {
    ...
    const handleSave = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`/students/update/student/${student_id}`, updateDto);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$src$2f$components$2f$ui$2f$button$2f$Button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: isSaving ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(List, "5R2FJGR9cfZc+QhHAOewgG8xOPE=", false, function() {
    return [
...
async function Fetch(endpoint) {
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}/${endpoint}`);
...
async function fetchClasses() {
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/class/all_classes");
...
async function fetchStudents() {
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get("/students/all_students");
...
function Allstudents() {
    ...
    const [selectedClass, setSelectedClass] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [selectedSex, setSelectedSex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    /* -------------------------------------------------------------------------- */ /*                            Fetch STUDENTS (API)                             */ /* -------------------------------------------------------------------------- */ const getStudents = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/students/all_students', {
                params: {
                    limit: itemsPerPage,
                    offset
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Allstudents.useEffect": ()=>{
            async function loadData() {
                try {
                    const { classList } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchClasses"])();
        ...
        "Allstudents.useEffect": ()=>{
            if (selectedSex === 'All') {
                ...
                const handler = setTimeout({
                    "Allstudents.useEffect.handler": async ()=>{
                        const offset = (currentPage - 1) * itemsPerPage;
                        try {
                            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/students/filter_student', {
                                params: {
                                    limit: itemsPerPage,
                                    offset,
                                    name: searchTerm,
                ...
                }["Allstudents.useEffect.handler"], 800);
                return ({
                    "Allstudents.useEffect": ()=>clearTimeout(handler)
                })["Allstudents.useEffect"];
            }
        }
    }["Allstudents.useEffect"], [
    ...
    /* ---------------- DELETE HANDLER ---------------- */ const handleDelete = async (id)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/students/delete/${id}`);
            if (res.data.deleted) {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    ...
                                                    classes.map((cls)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: cls.class_id,
                                                            children: [
                                                                cls.class_name,
                                                                " - ",
...
_s(Allstudents, "jMWz4ZhHa2/zdvKHmxevZfTFrVw=");
_c = Allstudents;
var _c;
...
//# sourceMappingURL=School%20Management%20System_220a9ca3._.js.map