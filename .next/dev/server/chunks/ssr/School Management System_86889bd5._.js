...
function Allstudents() {
    ...
    /* -------------------------------------------------------------------------- */ /*                            Fetch STUDENTS (API)                             */ /* -------------------------------------------------------------------------- */ async function getStudents() {
        try {
            ...
            const student = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fetch"])(url);
    ...
    /* -------------------------------------------------------------------------- */ /*                            Fetch CLASSES (API)                              */ /* -------------------------------------------------------------------------- */ async function getClasses() {
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$School__Management__System$2f$libs$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fetch"])("class");
            setClasses(res.data);
            console.log(classes);
        } catch (error) {
...
//# sourceMappingURL=School%20Management%20System_86889bd5._.js.map