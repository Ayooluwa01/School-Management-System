...
const navItems: NavItem[] = [ { name: "Admin Insights", emoji: "✨", path: "/admin/insights", gradientFrom: "#667eea", gradientTo: "#764ba2", allowedRoles: ["ADMIN"], isNew: true }, { name: "Dashboard", emoji: "🏠", path: "/dashboard", gradientFrom: "#f093fb", gradientTo: "#f5576c", allowedRoles: ["ADMIN", "TEACHER", "STUDENT", "PARENT", "STAFF"], }, { name: "Students", emoji: "🎓", gradientFrom: "#4facfe", gradientTo: "#00f2fe", allowedRoles: ["ADMIN", "TEACHER", "STAFF"], subItems: [ { name: "All Students", path: "/students/allstudents", emoji: "👥" }, { name: "Register Student", path: "/students/add", emoji: "➕", allowedRoles: ["ADMIN"] }, { name: "Upload CSV", path: "/students/Upload", emoji: "📄", allowedRoles: ["ADMIN"] }, { name: "Attendance", path: "/students/attendance", emoji: "📋" }, ], }, { name: "Staff", emoji: "👔", gradientFrom: "#fa709a", gradientTo: "#fee140", allowedRoles: ["ADMIN"], subItems: [ { name: "All Staff", path: "/staff", emoji: "📋" }, { name: "Add Staff", path: "/staff/add", emoji: "➕" }, ], }, { name: "Teachers", emoji: "👨‍🏫", gradientFrom: "#ffecd2", gradientTo: "#fcb69f", allowedRoles: ["ADMIN"], subItems: [ { name: "Assign Subjects", path: "/teachers/assign", emoji: "📚" }, { name: "Class Teachers", path: "/teachers/assignClass", emoji: "🏫" }, ], }, { name: "Class", emoji: "🏫", path: "/classes", gradientFrom: "#a8edea", gradientTo: "#fed6e3", allowedRoles: ["ADMIN", "TEACHER", "STAFF"] }, { name: "Subject", emoji: "📚", path: "/subjects", gradientFrom: "#ff9a9e", gradientTo: "#fecfef", allowedRoles: ["ADMIN", "TEACHER", "STAFF"] }, ]; const othersItems: NavItem[] = [ { name: "Examinations", emoji: "📝", gradientFrom: "#fbc2eb", gradientTo: "#a6c1ee", allowedRoles: ["ADMIN", "TEACHER", "STUDENT", "PARENT", "STAFF"], subItems: [ { name: "Result Entry", path: "/Exams/Entry", emoji: "✍️" }, { name: "Report Cards", path: "/Exams/Report-cards", emoji: "📊" }, ], }, { name: "Finance", emoji: "💰", gradientFrom: "#fdcbf1", gradientTo: "#e6dee9", allowedRoles: ["ADMIN", "PARENT", "STUDENT"], subItems: [ { name: "Fees & Dues", path: "/finance/fees", emoji: "💳" }, { name: "Expenses", path: "/finance/expenses", emoji: "💸", allowedRoles: ["ADMIN"] }, ], }, { name: "Settings", emoji: "⚙️", gradientFrom: "#d299c2", gradientTo: "#fef9d7", allowedRoles: ["ADMIN"], subItems: [ { name: "School Profile", path: "/settings/school", emoji: "🏛️" }, { name: "Academic Session", path: "/settings/session", emoji: "📅" }, ], }, ];
